  ...
  return (
    <div className={classes.nav} >
      <div className="icon">
        ...
        {/* <img className = {classes.imag} src = "https://drive.google.com/file/d/1fHDNEmwcZFoOeK7bmoX4Cb_M137HjqrB/view?usp=drive_link" alt="Icon" onClick = {handleHeading} /> */}
        </div>
      <div className={classes.appName} onClick={handleHeading}> &nbsp;  ClassMate Pro</div>
