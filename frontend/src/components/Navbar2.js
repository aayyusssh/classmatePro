...
function Navbar2(props) {
  ...
  return (
    <div className={classes.teams}>
      <div className={classes.title}>Groups</div>
      <div className={classes.options}>
        <div className={classes.join} style={{ marginRight: 20 }}>
          <Button variant="outlined" style={{ width: 190 }} onClick={handleOpenJoin} ><PersonAddIcon style={{ paddingRight: "5px" }} /> Join a Group</Button>
          ...
          >
            <Fade in={openJoin}>
              <div className={classes.paper}>
                ...
                <h2 id="transition-modal-title">Join a Group with Code</h2>
        ...
        <div className={classes.create} style={{}}>
          <Button variant="outlined" style={{ width: 190 }} onClick={handleOpenCreate}><CreateIcon style={{ paddingRight: "5px" }} />Create a Group</Button>
          ...
          >
            <Fade in={openCreate}>
              <div className={classes.paper}>
                <GroupWorkIcon className={classes.modalIcon} />
                <h2 id="transition-modal-title">Create a Group</h2>
                <p id="transition-modal-description">
                  <CssTextField
                    className={classes.margin}
                    // value={teamName.value}
